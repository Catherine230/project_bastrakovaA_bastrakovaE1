...
26.04 - Вывод данных из массива в верстку с использование метода forEach (), появление/закрытие всплывающих форм карточек.
27.04 - Создали объекты для карточек Вид Туризма, использование функции for in
